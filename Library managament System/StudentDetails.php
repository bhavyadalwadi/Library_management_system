...
session_start();
     if($_SESSION['SUsername'] == NULL) {
       header("location: StaffLogin.php?msg=You need to login");
     }
...
$SID = $_GET['SID'];
 ...
 if (!empty($SID)) {
$result = mysql_query("call StudentDetails('$SID')");
    if ($result === FALSE) {
    die(mysql_error());
    }
    ...
    while($row = mysql_fetch_array($result))
    {
      ...
      echo "<td style='color:red'>" . $row['Student_id']."</td>";
      echo "<td style='color:red'>" . $row['Student_Name']."</td>";
      echo "<td style='color:red'>" . $row['Surname']."</td>";
      echo "<td style='color:red'>" . $row['Sex']."</td>";
      echo "<td style='color:red'>" . $row['DOB']."</td>";
      echo "<td style='color:red'>" . $row['Borrow_ID']."</td>";
      echo "<td style='color:red'>" . $row['Department']."</td>";
      echo "<td style='color:red'>" . $row['Address']."</td>";
      echo "<td style='color:red'>" . $row['Phone_No']."</td>";
      echo "</tr>";
...
<p class="breadcrumb"><a href="AfterLoginF.php">HOME</a> Student Details</p>
<div id="content">
<p><form action="StudentDetails.php" method="GET">
