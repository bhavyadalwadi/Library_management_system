...
$SID = $_GET['SID'];
 ...
 if (!empty($SID)) {
$result = mysql_query("call GetBooksbyBorrowerID('$SID')");
    if ($result === FALSE) {
    die(mysql_error());
    }
    ...
    while($row = mysql_fetch_array($result))
    {
      ...
      echo "</tr>";
     //echo "<strong>Borrower ID : </strong>". $row['Borrower_ID'] . "<br><strong>BOOK_ID : </strong>" . $row['Book_ID'] . "<br><strong>Book_title : </strong>" . $row['book_Title'] . "<br><strong>Language : </strong>" . $row['LANGUAGE'] . "<br><strong>Borrowed on : </strong>" . $row['borrowed_from_date'] . "<br><br>";
    }
 } else {
    echo 'Supply the ID';
  }
...
<p class="breadcrumb"><a href="AfterLoginF.php">HOME</a> ID Details</p>
<div id="content">
<p><form action="borrower_id.php" method="GET">
