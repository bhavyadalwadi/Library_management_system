...
$SID = $_GET['SID'];
 ...
 if (!empty($SID)) {
$result = mysql_query("call GetBooksByISBN('$SID')");
    if ($result === FALSE) {
    die(mysql_error());
    }
    ...
    while($row = mysql_fetch_array($result))
    {
      ...
      echo "<td style='color:red'>" . $row['Actual_return_date']."</td>";
      echo "</tr>";
...
<p class="breadcrumb"><a href="AfterLoginF.php">HOME</a> ISBN Details</p>
<div id="content">
<p><form action="ByISBN.php" method="GET">
       Enter the Book ISBN:
